...
export const environment = {
  ...
  FORMULARIO_LISTA_PROFILE: '/profile',
  FORMULARIO_LISTA_BRANDS: "/brands",
  FORMULARIO_LISTA_LINES:"/lines",
  ...
  FORMULARIO_CRUD_DEL_PROFILE:"/profile",
  FORMULARIO_CRUD_DEL_PRODUCT:"/product",
  FORMULARIO_CRUD_DEL_BRAND:"/brands",
  FORMULARIO_CRUD_LINES:"/lines",
  RUTA_HOME : "/",
  PAGINA_INICIAL: 0,
  MODO_UPDATE : 'UPD',
  MODO_CREATE : 'INS',
