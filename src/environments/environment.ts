...
export const environment = {
  ...
  PRODUCTS_MODAL_EAN_CODE_FILTER: 'PRODUCTS_MODAL_EAN_CODE_FILTER',
  PRODUCTS_MODAL_STORE_CODE_FILTER:'PRODUCTS_MODAL_STORE_CODE_FILTER'
};
